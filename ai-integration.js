...
- В moves можешь указать ходы или пустой массив [] (пропуск хода)
        ...
        - 💀 ДИПЛОМАТИЯ = ОРУЖИЕ: используй сообщения с умом!
        - Можешь задавать ВОПРОСЫ, делать предложения, формировать или разрушать стратегические альянсы, пытаться манипулировать соперниками.
        - Сам решай когда выгодно быть честным, а когда обманывать или скрывать правду.
        - Помни: отправленное сообщение получатель прочтет только при СВОЕМ ходе!
- ⚡ ВНИМАТЕЛЬНО ЧИТАЙ ВХОДЯЩИЕ СООБЩЕНИЯ (←), анализируй их и тщательно продумывай вопросы и ответы - это может быть ключом к успеху!
